...
export function AdminDashboardPage() {
  ...
  const cards = [
    {
      title: "Users",
      val: currentStats.total_users ?? 0,
      icon: "lucide:users",
      color: "text-blue-500",
      bg: "bg-blue-500/10",
      id: "users",
    ...
    {
      title: "Students",
      val: currentStats.students_count ?? 0,
    ...
    {
      title: "Buddies",
      val: currentStats.buddies_count ?? 0,
    ...
    },
    {
      ...
      val: currentStats.active_one_on_one ?? 0,
      icon: "lucide:clock",
      color: "text-rose-500",
      bg: "bg-rose-500/10",
      id: "one-on-one",
    },
    {
      ...
      val: currentStats.total_achievements_issued ?? 0,
